...
INSERT INTO Configuration (Id, RootIssuer, DefaultCaExpiration, DefaultCertExpiration, BackboneCaExpiration, SiteDataplaneImage, BackboneControllerImage, ConfigSyncImage, SiteControllerImage)
    VALUES (0, 'skupperx-root', '30 days', '1 week', '1 year', 'quay.io/tedlross/skupper-router:skx-0.1.1', 'quay.io/tedlross/skupperx-site-controller:skx-0.1.1', 'quay.io/tedlross/skupper-config-sync:skx-0.1.1', 'quay.io/tedlross/skupper-site-controller:skx-0.1.1');
